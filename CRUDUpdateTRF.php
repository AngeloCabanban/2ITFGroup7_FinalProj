...
<body class="loggedin">
    ...
    <div class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <h2 class="mt-5">Update Terminal Report Form</h2>
                    <p>Please type in your Email Address and upload your Terminal Report Form in PDF file format.</p>
                            ...
                            if ($stmt = $mysqli->prepare('SELECT id, password FROM accounts WHERE email = ?')) {
                                ...
                                if ($stmt->num_rows > 0) {
                                    ...
                                    if (isset($_FILES['trf_pdf']['name']) && $trf == 'application/pdf') {
                                        ...
                                        move_uploaded_file($file_tmp, "./2ITFGroup7_FinalProj/terminal_report_form/" . $file_name);
                                        $updatequery = "UPDATE terminal_report_form SET email='$email', directory='/2ITFGroup7_FinalProj/terminal_report_form/', trf_pdf='$file_name', status='PENDING' WHERE id='$id'";
